...
- The role of this project is to extend functions for FDA in **`tidyfun`**. Specially, four functions were made for conducting fpca and function-on-scalar regression on **`tfd`** data types.
